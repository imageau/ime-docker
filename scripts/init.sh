...
$SED_CMD '/^AWS_ACCESS_KEY_ID/d' $BACK_PATH/.env
$SED_CMD '/^AWS_SECRET_ACCESS_KEY/d' $BACK_PATH/.env
$SED_CMD '/^AWS_ENDPOINT/d' $BACK_PATH/.env
$SED_CMD '/^AWS_DEFAULT_REGION/d' $BACK_PATH/.env
$SED_CMD '/^AWS_USE_PATH_STYLE_ENDPOINT/d' $BACK_PATH/.env
